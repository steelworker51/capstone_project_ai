...
def save_transactions(transactions, filename='financial_transaction.csv'):
...
def generate_report(transactions, filename='report.txt'):
    ...
    # Create timestamp string in YYYYMMDD format
...
if __name__ == '__main__':
    ...
    while True:
        ...
        print("3. Save Transactions to CSV")
        print("4. Generate Report to TXT")
        print("5. Exit")
