...
# you will have to add a transaction, then when you modify the type if you pick anything except for credit or debit it will give you an invalid id format